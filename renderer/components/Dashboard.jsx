    ...
    return (
        <div className="p-6 animate-fade-up">
            ...
            {trial && !trial.is_licensed && (
                <div className={`flex items-center justify-between px-4 py-3 rounded-xl mb-5 text-sm font-medium ${trial.trial_expired ? 'bg-red-50 dark:bg-red-900/20 text-red-600 border border-red-200 dark:border-red-800' : 'bg-amber-50 dark:bg-amber-900/20 text-amber-700 border border-amber-200 dark:border-amber-800'}`}>
